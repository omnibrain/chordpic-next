...
export default async function HelpPage({ params }: LocalizedPageProps) {
  const { locale } = await params;
  const { T, t } = createLocalizedT(
  ...
  // Batch attribute translations; the body uses async Server Components.
  const [
    fingersAlt,
    stringsAlt,
    barreAlt,
    ...
    t("Example of changing colors of fingers and barre chords"),
    t("Example of changing the shape of a finger"),
    t("Example of adding labels to strings"),
  ...
  return (
    <article className="prose prose-zinc max-w-none dark:prose-invert prose-headings:font-heading prose-a:underline-offset-4">
      ...
      <div className="flex justify-center">
        <Image src={toggleGif} alt={fingersAlt} />
      </div>
      <p>
        <T>
      ...
      <div className="flex justify-center">
        <Image src={silentstringsGif} alt={stringsAlt} />
      </div>
      <p>
        <T>
      ...
      <div className="flex justify-center">
        <Image src={barreGif} alt={barreAlt} />
      </div>
      <p>
        <T>
      ...
      <div className="flex justify-center">
        <Image src={editTextGif} alt={textAlt} />
      </div>
      <p>
        <T>
      ...
      <div className="flex justify-center">
        <Image src={editColorsGif} alt={colorsAlt} />
      </div>
      <p>
        <T>
      ...
      <div className="flex justify-center">
        <Image src={editShapesGif} alt={shapesAlt} />
      </div>
      <p>
        <T>
      ...
      <div className="flex justify-center">
        <Image src={labelsGif} alt={labelsAlt} />
      </div>
      ...
      <div className="flex justify-center">
        <Image src={samplechordGif} alt={chartAlt} />
      </div>
