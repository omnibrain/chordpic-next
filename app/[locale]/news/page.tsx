...
export default async function NewsPage({ params }: LocalizedPageProps) {
  const { locale } = await params;
  ...
  return (
    <article className="prose prose-zinc max-w-none dark:prose-invert prose-headings:font-heading prose-a:underline-offset-4">
      ...
      <div className="flex justify-center">
        <Image src={fretMarkers} alt={fretMarkersAlt} />
      </div>
      <p>
        <T>
      ...
      <div className="flex justify-center">
        <Image src={sliders} alt={slidersAlt} />
      </div>
      <p>
        <T>
      ...
      <div className="flex justify-center">
        <Image src={orientationToggle} alt={horizontalChordAlt} />
      </div>
      <p>
        <T>
      ...
      <div className="flex justify-center">
        <Image src={exampleHorizontalChord} alt={horizontalChordAlt} />
      </div>
      ...
      <div className="flex justify-center">
        <Image src={sampleChordWithColors} alt={colorsAlt} />
      </div>
      <p>
        <T>
      ...
      <div className="flex justify-center">
        <Image width={4} src={sampleChordWithText} alt={textAlt} />
      </div>
      <p>
        <T>
      ...
      <div className="flex justify-center">
        <Image src={barreAndFingerSameFret} alt={barreAlt} />
      </div>
      <p>
